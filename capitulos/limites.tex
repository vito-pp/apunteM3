...
\begin{example} Calcular los siguientes l\'imites usando \'algebra de l\'imites.
 ...
 \begin{enumerate}
     \item 
     \[
     \lim_{(x, y) \to (x_0, y_0)} \frac{x^2 + 1 + y}{(x - 1)^2 + y^2} \quad \text{con } x_0 = 0, \, y_0 = 0
     \]
 
     El numerador es un polinomio en dos variables, continuo en todo $\mathbb{R}^2$.  
     El denominador también es un polinomio, continuo en todo $\mathbb{R}^2$. La función es continua en todo punto donde el denominador no se anula, es decir $\mathbb{R}^2-(1,0)$. Por lo tanto se puede evaluar el límite directamente en $(0,0)$:
     \[
         \lim_{(x, y) \to (0,0)} \frac{x^2 + 1 + y}{(x - 1)^2 + y^2} = \frac{0^2 + 1 + 0}{(0 - 1)^2 + 0^2} = \frac{1}{1} = 1
     \]
 
     \item 
     \[
     \lim_{(x, y) \to (x_0, y_0)} \frac{e^{x^2} \log(\cos y)}{x^2 + (y + 1)^2} \quad \text{con } x_0 = 0, \, y_0 = 0
     \]
 
     \begin{itemize}
         \item $e^{x^2}$ es continua en $\mathbb{R}$.
         \item $\cos y$ es continua en $\mathbb{R}$, y como $\cos(0) = 1 > 0$, entonces $\log(\cos y)$ es continua en un entorno de $y_0 = 0$.
         \item $x^2 + (y + 1)^2$ es continua en $\mathbb{R}^2$ y no se anula en $(0,0)$:
     \end{itemize}
 
     Toda la función es continua en $(0,0)$, por lo tanto se puede evaluar directamente:
     \[
         \lim_{(x, y) \to (x_0, y_0)} \frac{e^{x^2} \log(\cos y)}{x^2 + (y + 1)^2} =  \frac{e^0 \cdot \log(1)}{0 + 1^2} = \frac{1 \cdot 0}{1} = 0
     \]
 \end{enumerate}
