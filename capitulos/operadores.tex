...
\begin{obs}
    ...
    \]
    De esta manera,   la divergencia es el producto escalar de $\grad$  con un campo vectorial  y para el caso del rotor en $\Rn{3}$ es el producto cruz  con un campo vectorial. \textcolor{red}{laplaciano}
...
\begin{propertie}
    ...
    \end{enumerate}
\end{propertie}
\begin{propertie} Sea $f,g$ de clase c1 y $F,G$ de clase c1
    Productos:
    \begin{enumerate}
