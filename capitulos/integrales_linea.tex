...
\begin{definition}
    Sea $\Gamma$ una curva simple en $\Rn{n}$ y sea $\boldsymbol{\sigma}:I\subseteq\R\to\Rn{n}$ una parametrizaci\'on regular $\mathcal{C}^1$ a troxos \textcolor{red}{ref particion $I_i$} de $\Gamma$. Se define la \textbf{longitud de} $\Gamma$, y se nota  Long($\Gamma$), a 
    \[
