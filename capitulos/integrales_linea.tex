...
\begin{example}
    ...
    Sean $\mathbf{p}$ y $\mathbf{q}$ dos puntos cualesquiera en \(\Rn{n}\). El segmento \(\overline{\mathbf{pq}}\) se puede parametrizar de forma lineal como
        ...
        \textcolor{red}{en la parte de topologia cuando introducimos la norma, notamos a la norma 2 como $\|\cdot\|_2$ y en el resto del documento no le ponemos subindice 2. habria que aclarar esto}
\end{example}
