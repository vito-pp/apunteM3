...
\begin{obs} Notemos que graficando solamente los conjuntos de nivel de los ejemplos 1 y 2, los mismos no son suficientes para determinar la gráfica de la función.
    \begin{center}
        \begin{tabular}{cc}
