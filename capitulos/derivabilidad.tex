...
\emph{Notaci\'on: derivadas de orden superior, derivadas parciales iteradas.} Sea $f:\Rn{2}\to\R$ de clase $\mathcal{C}^2$. Sus derivadas de segundo orden se notan de la siguiente manera:
\begin{gather*}
